...
function Start(){
	...
	$('#main3').css('background-color', 'white');
	$('#main4').css('background-color', 'white');
	adevar = 0;
	rinduri = 1;
	coloane = 1;
	Rinduri(1,1,'#main');
		...
		$('.A').show();
			$(".A").on({
				...
				mouseover : function(){
					...
					Rinduri(index+1,coloane,'#main3');
					Rinduri(index+1,coloane,'#main4');
				},
				mouseleave : function(){
					var index = $( ".A" ).index( this );
					var y = '.A:eq('+index+')';
					...
					Rinduri(1,coloane,'#main3');
					Rinduri(1,coloane,'#main4');
		...
		$('.B').show();
			$(".B").on({
				...
				mouseover : function(){
					...
					Coloane(rinduri,index+1,'#main3');
					Coloane(rinduri,index+1,'#main4');
				},
				mouseleave : function(){
					var index = $( ".B" ).index( this );
					var y = '.B:eq('+index+')';
					...
					Coloane(rinduri,1,'#main3');
					Coloane(rinduri,1,'#main4');
					$(y).css("border","black solid 1.5px");
				}
			});
	}
